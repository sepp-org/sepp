...
const sections: { table: SectionTable; fields: FieldSpec[] }[] = [
  ...
  { table: 'auth', fields: [] },
  {
    ...
    fields: [
      ...
      { key: 'retry_delay_ms', kind: 'number' },
      { key: 'retry_backoff', kind: 'string', options: ['none', 'exponential'] },
      { key: 'retry_delay_max_ms', kind: 'number' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'stats_history_ms', kind: 'number' },
    ],
  },
]
