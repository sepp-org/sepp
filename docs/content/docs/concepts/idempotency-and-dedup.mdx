...
- [Idempotent handlers](/docs/workers#idempotent-handlers): making the work itself safe to run more than once.
- [Job lifecycle & delivery](/docs/concepts/job-lifecycle): leasing, redelivery and the at-least-once guarantee.
- [Producing jobs](/docs/producers): setting an idempotency key when enqueueing.
