...
<Callout type="info" title="Scheduling a job in the past">
...
- [Producing jobs](/docs/producers#schedule-a-job): setting priority and a future run time per job.
- [Job lifecycle & delivery](/docs/concepts/job-lifecycle): the Scheduled and Ready states in context.
- [Queues & payloads](/docs/concepts/queues): per-queue priority and schedule-horizon limits.
