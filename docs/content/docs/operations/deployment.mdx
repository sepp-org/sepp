...
- **The admin UI is loopback-bound inside the container**, so publishing its port is not enough. To reach it, bind `0.0.0.0` and set `[admin] keys`; see [admin UI in Docker](/docs/get-started/admin-ui#in-docker).
