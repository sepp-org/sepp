...
This starts sepp with the default configuration, listening on `0.0.0.0:50051` (all interfaces, no authentication — see [security](/docs/operations/security) before exposing it) and persisting data to a `sepp-data` directory in the current working directory. 
...
First you need a client library. There are official clients for [Rust](https://github.com/sepp-org/sepp-rs), [Python](https://github.com/sepp-org/sepp-py) and [Node.js](https://github.com/sepp-org/sepp-js).
