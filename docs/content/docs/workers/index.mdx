...
Because jobs run concurrently — and because any job can be retried or redelivered — handlers should be safe to run more than once. See [idempotent handlers](#idempotent-handlers).
